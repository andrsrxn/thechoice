...
export const MainNavigation = ({ open: _open = false }: { open?: boolean }) => {
  ...
  const closeMenuAndTransition = () => {
    ...
    startTransition(() => {
      setOpen(false)
      // Other state updates that trigger navigation or content change can go here
    })
  }
  return (
    // tabindex
    <div className='laptop:w-full'>
      ...
      <nav
        ...
        <ul className='mx-auto grid w-11/12 laptop:flex laptop:w-full laptop:items-center laptop:justify-between laptop:gap-8'>
