...
const InputComponent = ({ className, ...props }: React.ComponentProps<'input'>) => (
  <Input className={cn('rounded-s-none rounded-e-lg squircle', className)} {...props} />
)
...
const FlagComponent = ({ country, countryName }: RPNInput.FlagProps) => {
  ...
  return (
    <span className="flex h-4 w-6 overflow-hidden rounded-sm bg-foreground/20 squircle [&_svg:not([class*='size-'])]:size-full">
